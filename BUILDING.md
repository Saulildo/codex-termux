...
- Recommended publish order: publish the tested package to npm `next`, validate it on Termux, create the GitHub release from the public release commit, and move the npm package to `latest`.
